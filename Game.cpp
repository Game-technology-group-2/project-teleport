...
//    if (keys[SDL_SCANCODE_W]) player.move(Helpers::Direction::FORWARD, 0.1f);
//    if (keys[SDL_SCANCODE_S]) player.move(Helpers::Direction::BACKWARD, 0.1f);
//    if (keys[SDL_SCANCODE_A]) player.move(Helpers::Direction::LEFT, 0.1f);
//    if (keys[SDL_SCANCODE_D]) player.move(Helpers::Direction::RIGHT, 0.1f);
//
